...
contents = glob.glob("E:\PES\CDSAML\DatasetC\Binary Videos\*\*.mp4")
...
for path in contents:
    ...
    gait_cycle_estimate = feat_extract.calc_gait_cycle(video)
    ...
    spatial_feature_vector = feat_extract.calc_spatial_component(gait_cycle_estimate[0], gait_cycle_estimate[1],
    ...
    temporal_feature_vector = feat_extract.calc_temporal_component(gait_cycle_estimate[3])
    ...
    wavelet_component = feat_extract.calc_wavelet_component(gait_cycle_estimate[4], gait_cycle_estimate[2])
