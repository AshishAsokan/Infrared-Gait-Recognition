...
# contents = glob.glob(r'E:\PES\CDSAML\Gait_IR\VIDS\Test\*.mp4')
contents = glob.glob(r'E:\Softwares\PyCharm\PyCharm Community Edition 2018.2.4\Projects\Gait Analysis\Train_videos\*.mp4')
train_vector = []
mean_vector = []
responses_train = []
...
for path in contents:
    ...
    # train_vector = spatial_temporal_parameters
